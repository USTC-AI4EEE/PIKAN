...
class ParameterSensitivityAnalysis:
    ...
    def run_single_sheet(self, sheet_name, filename=None):
        ...
        try:
            ...
            if filename is None:
                filename = f'TJU_PSA_{sheet_name[-1]}.svg'
...
if __name__ == '__main__':
    # 设置表格文件路径
    file_path = 'results_soh-estimation/processed_results/PIKAN_opt/PIKAN_opt_TJU_results_group_mean.xlsx'
    ...
    sheet_names = [f'group_mean_{i}' for i in range(0, 3)]
