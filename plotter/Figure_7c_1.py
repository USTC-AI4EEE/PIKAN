...
kan_model_forecast = np.load(root+'mit_kan_model_forecast.npy')
kan_symbolic_forecast = np.load(root+'mit_kan_symbolic_forecast.npy')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('../Figures/mit_true_vs_model_vs_symbolic.svg',format='svg')
plt.show()