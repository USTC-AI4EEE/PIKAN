...
kan_model_forecast = np.load(root+'xjtu_batch_0_kan_model_forecast.npy')
kan_symbolic_forecast = np.load(root+'xjtu_batch_0_kan_symbolic_forecast.npy')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('../Figures/xjtu_batch_0_true_vs_model_vs_symbolic_bold.svg',format='svg')
plt.show()