...
plt.style.use('own_style_6.mplstyle')   # 1
...
merge_df_keys = ['PIKAN', 'KAN', 'PINN', 'MLP', 'BLT']
...
fig, ax = plt.subplots(figsize=(9,6),dpi=300) # 8, 6
...
plt.tight_layout()
plt.savefig(f'../Figures/small_sample_HUST_m6_bold.svg',format='svg')
plt.show()
