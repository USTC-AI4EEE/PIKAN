...
def main():
    ...
    for e in range(10):
        set_seed(e)         
        setattr(args, 'save_folder', f'results_soh-estimation/{args.model_name}/MIT results/Experiment{e + 1}')
...
def small_sample():
    ...
    for n in [1,2]:
        ...
        for e in range(10):
            set_seed(e)         
            save_folder = f'results_small-sample/{args.model_name}/MIT results (small sample {n})/Experiment' + str(e + 1) 
